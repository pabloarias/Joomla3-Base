...
<install version="2.0" type="plugin" plugin="clipboard" core="1" editable="1">
    ...
    <creationDate>19 July 2014</creationDate>
    ...
    <params group="standard">
        ...
        <param name="paste_strip_class_attributes" type="radio" default="0" label="WF_PASTE_PARAM_CLASSES" description="WF_PASTE_PARAM_CLASSES_DESC">
            <option value="1">WF_OPTION_YES</option>
            <option value="0">WF_OPTION_NO</option>
        </param>
        ...
        <param name="paste_remove_styles" type="radio" default="0" label="WF_PASTE_PARAM_STYLES" description="WF_PASTE_PARAM_STYLES_DESC">
            <option value="1">WF_OPTION_YES</option>
            <option value="0">WF_OPTION_NO</option>
        </param>
        ...
        <param name="paste_retain_style_properties" placeholder="eg: font-size,font-family,color" class="input-xlarge" size="50" type="text" default="" label="WF_PASTE_PARAM_RETAIN_STYLES" description="WF_PASTE_PARAM_RETAIN_STYLES_DESC" />
    ...
    <params group="buttons">
        <param name="buttons" class="checklist buttonlist" type="list" multiple="multiple" default="cut,copy,paste,pastetext" label="WF_PARAM_BUTTONS" description="WF_PARAM_BUTTONS_DESC">
            ...
            <option value="pastetext">Paste As Plain Text</option>
        </param>
    </params>
    <help>
