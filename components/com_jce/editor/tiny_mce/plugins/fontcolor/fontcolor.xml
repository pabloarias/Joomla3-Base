...
<install version="2.0" type="plugin" plugin="fontcolor" core="1" editable="1">
    ...
    <params group="standard">
        <param name="foreground_color" type="text" class="color" size="10" default="#000000" label="WF_FONTCOLOR_FORECOLOR" description="WF_FONTCOLOR_FORECOLOR_DESC"/>
        <param name="background_color" type="text" class="color" size="10" default="#000000" label="WF_FONTCOLOR_BACKCOLOR" description="WF_FONTCOLOR_BACKCOLOR_DESC"/>
    </params>
