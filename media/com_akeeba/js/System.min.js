...
*/
if("undefined"==typeof akeeba)var akeeba={};"undefined"==typeof akeeba.System&&(akeeba.System={},akeeba.System.documentReady=function(a,b){},akeeba.System.notification={hasDesktopNotification:!1,iconURL:""},akeeba.System.params={AjaxURL:"",errorCallback:akeeba.System.modalErrorHandler,password:"",errorDialogId:"errorDialog",errorDialogMessageId:"errorDialogPre"},akeeba.System.modalDialog=null);akeeba.System.defaultErrorHandler=function(a){alert("An error has occurred\n"+a)};
akeeba.System.modalErrorHandler=function(a){var b=document.getElementById(akeeba.System.params.errorDialogId),c="error";null!=b&&(document.getElementById(akeeba.System.params.errorDialogMessageId).innerHTML=a,c=b.innerHTML);akeeba.Modal.open({content:c,width:"80%"})};akeeba.System.params.errorCallback=akeeba.System.modalErrorHandler;
akeeba.System.doAjax=function(a,b,c,d,f){null==d&&(d=!0);var e=(new Date).getTime()/1E3,g=parseInt(e,10),e=Math.round(1E3*(e-g))/1E3;a._cacheBustingJunk=e;null==f&&(f=6E5);a={type:"POST",url:akeeba.System.params.AjaxURL,cache:!1,data:a,timeout:f,success:function(a){var e="",d=a.indexOf("###");if(-1==d)a=akeeba.System.sanitizeErrorMessage(a),a="Invalid AJAX data: "+a,null==c?null!=akeeba.System.params.errorCallback&&akeeba.System.params.errorCallback(a):c(a);else{0!=d?(a.substr(0,d),e=a.substr(d)):
e=a;e=e.substr(3);d=e.lastIndexOf("###");e=e.substr(0,d);try{var f=JSON.parse(e)}catch(g){e=akeeba.System.sanitizeErrorMessage(e);a=g.message+"\n<br/>\n<pre>\n"+e+"\n</pre>";null==c?null!=akeeba.System.params.errorCallback&&akeeba.System.params.errorCallback(a):c(a);return}b(f)}},error:function(a,b,e){e=a.responseText?a.responseText:"";var d="<strong>AJAX Loading Error</strong><br/>HTTP Status: "+a.status+" ("+a.statusText+")<br/>",d=d+"Internal status: "+b+"<br/>XHR ReadyState: "+a.readyState+"<br/>",
d=d+"Raw server response:<br/>"+akeeba.System.sanitizeErrorMessage(e);null==c?null!=akeeba.System.params.errorCallback&&akeeba.System.params.errorCallback(d):c(d)}};d?akeeba.Ajax.enqueue(a):akeeba.Ajax.ajax(a)};akeeba.System.sanitizeErrorMessage=function(a){-1<a.indexOf("<script")&&(a="(HTML containing script tags)");return a};
