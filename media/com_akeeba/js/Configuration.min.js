...
akconfig_pcloud_oauth_callback=function(a){document.getElementById("var[engine.postproc.pcloud.access_token]").value=a.access_token;myWindow=window.open("","akeeba_pcloud_window");myWindow.close()}; //# sourceMappingURL=Configuration.min.map
